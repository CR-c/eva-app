          ...
          <View style={{ padding: '32rpx' }}>
            ...
            >
              ...
              <View className="flex" style={{ gap: '24rpx' }}>
                ...
                >
                  <View className="flex items-center justify-center" style={{ gap: '8rpx', marginBottom: '8rpx' }}>
                  ...
                  <Text className="text-[#64748b]" style={{ fontSize: '24rpx' }}>体重变化</Text>
                </View>
                ...
                >
                  ...
                  <Text className="text-[#64748b]" style={{ fontSize: '24rpx' }}>身高变化</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          {growthRecords.length === 0 ? (
            ...
            <View style={{ display: 'flex', flexDirection: 'column', gap: '24rpx' }}>
              {growthRecords.map((record, index) => (
                ...
                >
                  <View className="flex items-center justify-between" style={{ marginBottom: '20rpx' }}>
                    <View>
                      <Text
                    ...
                    <Text className="text-[#94a3b8]" style={{ fontSize: '32rpx' }}>⋯</Text>
                  </View>
                  ...
                  <View className="flex" style={{ gap: '16rpx', marginBottom: '20rpx' }}>
                    {record.weight && (
                      ...
                      >
                        <Text className="block font-bold text-[#25aff4]" style={{ fontSize: '32rpx' }}>
                          {record.weight}
                        </Text>
                    ...
                    {record.height && (
                      ...
                      >
                        <Text className="block font-bold text-[#22c55e]" style={{ fontSize: '32rpx' }}>
                          {record.height}
                        </Text>
                        <Text className="block text-[#64748b]" style={{ fontSize: '22rpx' }}>
                          身高 (cm)
                  ...
                  {record.notes && (
                    ...
                    >
                      <Text className="text-[#475569]" style={{ fontSize: '26rpx', lineHeight: '40rpx' }}>
                        {record.notes}
                      </Text>
                    </View>
                  )}
